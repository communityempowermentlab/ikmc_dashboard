...
// ── Main FilterDrawer ─────────────────────────────────────────────────────────
const FilterDrawer = ({ isOpen, onClose, exportImage, isExporting }) => {
    ...
    <>
      ...
      <div className={`filter-drawer ${isOpen ? 'open' : ''}`}>
        ...
        <div className="filter-drawer-body">
          ...
          <div className="vis-wrap">
            <div className="vis-header">
              <span className="dr-section-label">Export Actions</span>
            </div>
            <div className="vis-feature-list" style={{ gap: '10px', display: 'flex', flexDirection: 'column' }}>
              <button className="btn-drawer btn-drawer-reset" style={{ width: '100%', display: 'flex', justifyContent: 'center', gap: '8px' }} onClick={exportImage} disabled={isExporting} title="Export as Image">
              ...
              <button className="btn-drawer btn-drawer-apply" style={{ width: '100%', display: 'flex', justifyContent: 'center', gap: '8px' }} onClick={() => window.print()} title="Export as PDF">
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 10v3h10v-3M5 7l3 3 3-3M8 1v9"/></svg>
                Export PDF
              </button>
            </div>
          </div>
